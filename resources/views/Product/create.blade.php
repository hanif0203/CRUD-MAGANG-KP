                ...
                <form action="{{route('Product.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('purchase_price') is-invalid @enderror" name="hargabeli" id="hargabeli" value="{{ old('purchase_price') }}" placeholder="Masukan harga Beli Produk">
                        ...
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('selling_price') is-invalid @enderror" name="hargajual" id="hargajual" value="{{ old('selling_price') }}" placeholder="Masukan harga Jual Produk">
                            @error('selling_price')
                            <div class="text-danger"><small>{{ $message }}</small></div>
                        @enderror
                        </div>
