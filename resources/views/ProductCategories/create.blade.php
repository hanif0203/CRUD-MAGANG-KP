                ...
                <form action="{{route('ProductCategories.store')}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" class="form-control @error('namakategori') is-invalid @enderror" name="namakategori" id="namakategori" value="{{ old('namakategori') }}" placeholder="Masukan Kategori Prpduk">
                            @error('namakategori')
